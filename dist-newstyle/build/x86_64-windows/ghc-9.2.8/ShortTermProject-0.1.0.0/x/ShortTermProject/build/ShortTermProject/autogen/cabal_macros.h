...
/* package ShortTermProject-0.1.0.0 */
#ifndef VERSION_ShortTermProject
#define VERSION_ShortTermProject "0.1.0.0"
#endif /* VERSION_ShortTermProject */
#ifndef MIN_VERSION_ShortTermProject
#define MIN_VERSION_ShortTermProject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ShortTermProject */
...
#define CURRENT_COMPONENT_ID "ShortTermProject-0.1.0.0-inplace-ShortTermProject"
